...
This document is intended to provide the reader with an insight into the core component repositories and the documentation currently available for Mojaloop. Navigation within the document and the respective repositories are possible by following the hyper-link.

#### Assumptions and related matters.
All references point to master branch of the repositories. The project team is in the process to insure this is current and up to date as per the latest project release.
